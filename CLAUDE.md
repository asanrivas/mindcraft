...
```
digCost 14   treeDigCost 60   waterCost 15   dropCost 5   climbCost 1.5   unknownCost 3
...
- **`waterCost` is high because swimming barely works here**, not merely because it is slow.
...
- **Water**: `skills.escapeWater` heads for the nearest dry bank. Pillaring cannot work while
  floating - there is nowhere to place a block underneath - and steering at the distant goal
  just pushes the bot further into the river.
